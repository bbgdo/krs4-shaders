...
namespace PostEffects.Scripts {
    public static class EffectProcessor {
        ...
        private static void SaveRenderTexture(RenderTexture rt, EffectContext context) {
            ...
            string fileName = $"{context.outputPrefix}_{context.fileName}";
